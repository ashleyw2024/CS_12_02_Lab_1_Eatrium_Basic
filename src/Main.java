    ...
    public static void main(String[] args) {
        ...
        if (userName == null || userName.equals("")){
            while (userName == null || userName.equals("")) {
                System.out.println("You cannot leave this empty. Please input your full name.");
        ...
        while (!userAction.equalsIgnoreCase("exit")){
            System.out.println("Input 1 to check past orders and input 2 to make a new order. Input 'exit' at anytime to leave");
